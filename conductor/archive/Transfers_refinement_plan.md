# Plan: Final Pixel-Perfect Refinement for Tranfers W2-W1.html

**Goal:** Synchronize `Tranfers W2-W1.html` perfectly with the "Gold Standard" set by `Return&Claim.html`. This ensures consistent CSS variables, glass-morphism classes, typography weights, and responsive shell design while strictly preserving all inter-warehouse transfer, request, and dispatch logic.
...
- **View UI:** 
    - **W1 (Request):** Refine the form to be high-density and minimal.
    - **W2 (Tasks):** Update the task cards to use standardized weights and spacing.
    - **Analytics:** Refine the insight cards and charts to match the minimal aesthetic.

### Task 3: Functional Preservation

- **Logic:** Maintain `handleW1Submit`, `handleDispatchSubmit`, and `updateItemStatus`.
- **Data:** Maintain `fetchInitialData`, `syncDataToSheet`, and all date formatters.
...
3. **Logic:** Test creating a transfer request and dispatching it.
